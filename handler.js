    ...
    try {
        ...
        try {
            ...
            if (user) {
                ...
                if (!('banned' in user))
                    user.banned = false
                if (!isNumber(user.bannedExpired))
                    user.bannedExpired = 0
            ...
            if (chat) {
                ...
                if (!('game' in chat))
                    chat.game = true
                if (!('hitung_angka' in chat))
                    chat.hitung_angka = false
                if (!('teks' in chat))
                    chat.teks = false
